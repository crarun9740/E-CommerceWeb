...
function Infofootwear() {
  const { id } = useParams();
  const dispatch = useDispatch();
  const product = footwear.find((mb) => mb.id.toString() === id);
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="border-t border-gray-100 pt-6">
                ...
                <div className="space-y-4">
                  ...
                  {product.specifications.soleType && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">SoleType</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.soleType}
                      </span>
                    </div>
                  ...
                  {product.specifications.closureType && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">ClosureType</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.closureType}
                      </span>
                    </div>
              ...
              <div className="flex justify-between items-center gap-4 mt-8">
                ...
                <button
                  ...
                  className="flex-1 py-4 px-6 bg-black text-white rounded-xl font-medium transition-all duration-300 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-800 flex justify-center items-center gap-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"

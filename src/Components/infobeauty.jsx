...
function Infobeauty() {
  ...
  const { id } = useParams();
  const product = beauty.find((mb) => mb.id.toString() === id);
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="border-t border-gray-100 pt-6">
                ...
                <div className="space-y-4">
                  {product.specifications.frameMaterial && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">FrameMaterial</span>
                  ...
                  {product.specifications.lensMaterial && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">LensMaterial</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.lensMaterial}
                      </span>
                    </div>
                  ...
                  {product.specifications.frameStyle && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">FrameStyle</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.frameStyle}
                      </span>
                    </div>
                  ...
                  {product.specifications.occasion && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">Occassion</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.occasion}
                      </span>
                    </div>
              ...
              <div className="flex justify-between items-center gap-4 mt-8">
                <button
                  ...
                  className="flex-1 py-4 px-6 bg-white border border-gray-200 rounded-xl font-medium text-gray-800 transition-all duration-300 hover:bg-gray-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-gray-200 flex justify-center items-center gap-2 cursor-pointer"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"

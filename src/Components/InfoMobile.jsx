              ...
              <div className="border-t border-gray-100 pt-6">
                ...
                <div className="space-y-4">
                  {product.specifications.display && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">Display</span>
                  ...
                  {product.specifications.processor && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">Processor</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.processor}
                      </span>
                    </div>
                  ...
                  {product.specifications.ram && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">Ram</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.ram}
                      </span>
                    </div>
                  ...
                  {product.specifications.storage && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">Storage</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.storage}
                      </span>
                    </div>
                  ...
                  {product.specifications.camera && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">Camera</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.camera}
                      </span>
                    </div>
                  ...
                  {product.specifications.battery && (
                    <div className="flex">
                      <span className="w-1/3 text-gray-500">battery</span>
                      <span className="w-2/3 font-medium">
                        {product.specifications.battery}
                      </span>
                    </div>
